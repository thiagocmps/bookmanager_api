...
bookRouter.patch(
  "/updateuserbookreview/:id",
  utilities.getBookById,
...
/* DELETE userbook */
bookRouter.delete("/deleteuserbook/:id", utilities.getBookById, async function (req, res) {
  try {
    await res.userbook.deleteOne();
